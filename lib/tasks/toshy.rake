...
task :toshy do
  ...
  Dir.mktmpdir do |tmpdir|
    ...
    command '/usr/bin/curl', '-fsSL', 'https://github.com/RedBearAK/toshy/archive/refs/tags/Toshy_v25.01.1.tar.gz',
  ...
  config = config_dir/'toshy_config.py'
  ...
  config.write <<~'PYTHON'
    ...
    keymap("OptSpecialChars - Any", {
        C("LCtrl-Backspace"): C("Delete"),
        C("Alt-E"):                     C("RAlt-E"),                # € Euro sign
        C("Alt-1"):                     UC(0x00A1),                 # ¡
        C("Alt-2"):                     C("RAlt-B"),                # “
        C("Shift-Alt-2"):               C("RAlt-N"),                # ”
        C("Shift-Alt-W"):               C("RAlt-V"),                # „
        C("Alt-3"):                     C("RAlt-R"),                # ¶
        C("Alt-4"):                     C("RAlt-C"),                # ¢
        C("Alt-5"):                     C("RAlt-8"),                # [
        C("Alt-6"):                     C("RAlt-9"),                # ]
        C("Alt-7"):                     C("RAlt-KEY_102ND"),        # | Vertical line
        C("Shift-Alt-7"):               C("RAlt-Minus"),            # \
        C("Alt-8"):                     C("RAlt-7"),                # {
        C("Alt-9"):                     C("RAlt-0"),                # }
        C("Alt-0"):                     UC(0x2260),                 # ≠
        C("Alt-Right_Brace"):           UC(0x00B1),                 # ±
        C("Alt-Minus"):                 UC(0x00BF),                 # ¿
        C("Alt-N"):                     C("RAlt-Right_Brace"),      # ~ Tilde
        C("Alt-M"):                     C("RAlt-M"),                # µ
        C("Alt-Dot"):                   C("RAlt-Dot"),              # … Horizontal ellipsis
        C("RCtrl-Q"):                   C("RAlt-Q"),                # @
        C("Super-Ctrl-F"):              C("F11"),                   # Full screen
